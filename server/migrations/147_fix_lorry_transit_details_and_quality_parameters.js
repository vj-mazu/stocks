...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    console.log('🔄 Running database repair migration 147...');
    ...
    try {
      ...
      `);
      console.log('✅ Added sute, suteNetWeight, partyWbEnabled, wbDate, wb_added_by, wb_added_at columns to lorry_transit_details');
    } catch (err) {
