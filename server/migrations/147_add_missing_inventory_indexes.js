...
module.exports = {
    async up() {
        const indexes = [
            // Enable pg_trgm extension (safe - migration 94 already does this, but belt-and-suspenders)
            `CREATE EXTENSION IF NOT EXISTS pg_trgm`,

            // pg_trgm GIN indexes for sample_entries text search columns NOT covered by migration 94
       ...
       ON sample_entries USING gin (sample_collected_by gin_trgm_ops)`,
            ...
            // inventory_quality_parameters indexes (zero existed before this migration)
