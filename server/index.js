...
const inTransitRoutes = require('./routes/in-transit');
const bandMalalBookRoutes = require('./routes/band-malal-book');
...
app.use('/api/arrivals', inTransitRoutes);
app.use('/api/arrivals', bandMalalBookRoutes);
