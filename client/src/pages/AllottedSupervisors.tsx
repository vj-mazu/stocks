...
const AllottedSupervisors: React.FC = () => {
  ...
  const [showFR2Prompt, setShowFR2Prompt] = useState(false);
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 10000 }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '24px', maxWidth: '400px', width: '90%', boxShadow: '0 10px 40px rgba(0,0,0,0.2)' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
              ...
              <button onClick={() => { setShowFR2Prompt(false); setShowFR2Form(true); }}
                style={{ padding: '8px 16px', background: '#1a237e', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer', fontWeight: 600, fontSize: '14px' }}>
                Yes, Add FR2
              </button>
            </div>
          </div>
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 10000 }}>
          <div style={{ background: 'white', borderRadius: '12px', padding: '24px', maxWidth: '500px', width: '95%', maxHeight: '85vh', overflowY: 'auto', boxShadow: '0 10px 40px rgba(0,0,0,0.2)' }}>
            ...
            <div style={{ marginTop: '10px' }}>
              ...
              <textarea value={fr2Data.finalRemarks2} onChange={e => setFr2Data({...fr2Data, finalRemarks2: e.target.value})}
          ...
          targetRateLinkAction={async (rateInfo) => {
            ...
            try {
              ...
              const payload = {
                ...
                bankLoan: (rateInfo as any).bankLoan,
                bankLoanValue: (rateInfo as any).bankLoanValue,
                bankLoanUnit: (rateInfo as any).bankLoanUnit,
